...
NTSTATUS CreateMiniportTopology( OUT PUNKNOWN *Unknown, IN REFCLSID,
...
NTSTATUS CMiniportTopology::DataRangeIntersection( IN  ULONG PinId, IN  PKSDATARANGE ClientDataRange,
...
STDMETHODIMP CMiniportTopology::Init( IN PUNKNOWN UnknownAdapter,
  IN PRESOURCELIST ResourceList, IN PPORTTOPOLOGY Port_ )
...
/*  QueryInterface for MiniportTopology
    Arguments: Interface - GUID of the interface
